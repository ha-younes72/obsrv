      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={{ flexDirection: 'row', width: '100%', borderRadius: 5, marginBottom: 25 }} >
              <TextInput
                onFocus={() => {
                  this.setState({
                    focus: true
            ...
            <View style={{ flexDirection: 'row', width: '100%', borderRadius: 5, marginBottom: 30 }} >
              <TextInput
                onFocus={() => {
                  this.setState({
                    focus: true
        ...
        <View
          ...
          <View style={{ flex: 5, justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
            ...
            <TouchableOpacity
              ...
              style={{ paddingLeft: 7 }}
            >
              <Text style={{ fontSize: 17, color: '#275D9E' }}>
                Sign Up
							</Text>
            </TouchableOpacity>
          </View>
